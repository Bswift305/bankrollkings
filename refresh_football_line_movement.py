...
STEPS = [
    ("nfl_game_lines", [sys.executable, "fetch_nfl_game_lines.py", "--days", "130"], 240),
    ("ncaaf_game_lines", [sys.executable, "fetch_ncaaf_game_lines.py", "--days", "130"], 240),
]


def main() -> int:
    print("=" * 60)
    print("BANKROLL KINGS - FOOTBALL LINE MOVEMENT REFRESH")
    print("=" * 60)
    ...
    for label, command, timeout in STEPS:
        ...
        print()
    print("Football line movement refresh completed.")
    return 0
