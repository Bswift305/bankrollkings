...
ROUTE_CHECKS: tuple[RouteCheck, ...] = (
    ...
    RouteCheck("/sports/nfl?postseason=1", "NFL Command", ("NFL Preseason Intelligence", "NFL Command Surface"), "football", True),
    ...
    RouteCheck("/sports/ncaaf?postseason=1", "CFB Command", ("College Football Preseason Intelligence", "Roster Coverage"), "football", True),
