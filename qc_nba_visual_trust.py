...
def run_qc() -> dict:
    ...
    report = {
        ...
        "notes": "Verified key NBA surfaces expose trust markers for verdict, market, trajectory, and injury context.",
        "warnings": warnings,
        "failures": failures,
    }
    append_qc_run_log("nba_visual_trust", report)
    return report
