...
def run_qc() -> dict:
    ...
    report = {
        ...
        "notes": "Verified key NFL surfaces expose trust markers for live feed state, method framing, and plain-English verdict language.",
        "warnings": warnings,
        "failures": failures,
    }
    append_qc_run_log("nfl_visual_trust", report)
    return report
